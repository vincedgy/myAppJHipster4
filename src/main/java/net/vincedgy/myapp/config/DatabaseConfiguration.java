package net.vincedgy.myapp.config;
...
@EnableMongoRepositories("net.vincedgy.myapp.repository")
...
public class DatabaseConfiguration {
    ...
    public Mongobee mongobee(Mongo mongo, MongoProperties mongoProperties) {
        ...
        mongobee.setChangeLogsScanPackage("net.vincedgy.myapp.config.dbmigrations");
