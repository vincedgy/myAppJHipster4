...
import net.vincedgy.myapp.config.audit.AuditEventConverter;
import net.vincedgy.myapp.domain.PersistentAuditEvent;
import net.vincedgy.myapp.repository.PersistenceAuditEventRepository;
import net.vincedgy.myapp.service.AuditEventService;
